...
O custo nao e recalculado aqui: a prova pergunta o mesmo numero ao
utils/lucro_migrado (media movel ponderada) e exige que a tela mostre AQUELE
valor -- no dia em que as duas telas divergirem, esta prova cai.
...
# ---- o que o banco diz, por outro caminho ----
hoje = hoje_brasilia()
conn = get_db_connection()
cur = conn.cursor(dictionary=True)
apurado = lucro_migrado.apurar(cur, 1, [1, 2, 4, 5], hoje, hoje)
