...
function obterValorPorLitroRota() {
    ...
    // Destino preferencial: o hidden destino (enviável) ou o select (se tiver), senão data-destino-id do cliente
...
function calcularQuantidade() {
    ...
    if (selectQuantidade && selectQuantidade.value) {
        ...
        // garantir leitura de número sem formatação
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (clienteSelect && destinoSelect) {
        clienteSelect.addEventListener('change', function() {
            ...
            if (destinoId) {
                ...
                // Se cliente sem município, garantir campo disponível (mas regra exige que destino respeite cadastro do cliente;
                // aqui deixamos liberado caso cliente não tenha destino cadastrado)
                ...
                const hidden = document.getElementById('destino_id_hidden');
    ...
    const camposRecalculo = [
        ...
        'quantidade_tipo',
        'origem_id',
        // 'destino_id', // destino é sempre vindo do cliente (disabled + hidden)
