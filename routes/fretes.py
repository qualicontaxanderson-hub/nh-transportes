...
# =============================
# IMPORTAR PEDIDO (MÚLTIPLOS ITENS)
# =============================
...
def importar_pedido(pedido_id):
    ...
    try:
        ...
        # ✅ CORREÇÃO: Buscar rotas com PIPE (|)
...
def novo():
    ...
    if request.method == 'POST':
        try:
            ...
            # Tipo de quantidade (personalizada ou padrão)
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if not destino_id or destino_id == '':
                flash('ERRO: Destino obrigatório!', 'danger')
            ...
            cursor.execute("""
                UPDATE fretes SET
                    ...
                    preco_produto_unitario=%s, total_nf_compra=%s, preco_por_litro=%s,
                    valor_total_frete=%s, comissao_motorista=%s, valor_cte=%s, comissao_cte=%s, lucro=%s,
