...
def novo():
    if request.method == 'POST':
        try:
            ...
            """, (
                request.form['clientes_id'], request.form['fornecedores_id'],
                request.form['motoristas_id'], request.form['veiculos_id'],
                request.form['quantidade_id'], request.form['origem_id'],
                request.form['destino_id'], request.form['preco_produto_unitario'],
                request.form['total_nf_compra'], request.form['preco_por_litro'],
                request.form['valor_total_frete'], request.form['comissao_motorista'],
                request.form['valor_cte'], request.form['comissao_cte'],
                request.form['lucro'], request.form['data_frete'],
                request.form['status'], request.form.get('observacoes', '')
            ))
    ...
    try:
        ...
        return render_template('fretes/novo.html',
                             ...
                             quantidades=quantidades, origens=origens,
                             destinos=destinos)
    except Exception as e:
